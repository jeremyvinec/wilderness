import { LOGIN, SIGNUP, UPDATE_AVATAR, UPDATE_EMAIL, UPDATE_LOCATION, UPDATE_NAME_REGION, UPDATE_PASSWORD, UPDATE_STYLE_URL, UPDATE_USERNAME } from '../../actions/actionTypes'
